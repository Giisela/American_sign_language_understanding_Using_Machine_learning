...
def generate_logistic_classifier():
    ...
    classifier_model = linear_model.LogisticRegression(solver='lbfgs',multi_class='multinomial')
    print("Done!\n")
...
def init_train_logistic_classifier():
    model_output_dir_path = ('./dados/labels/result/')
    model_stats_file_path = os.path.join(model_output_dir_path, "stats-logistic.txt")
    ...
    with open(model_stats_file_path, "w") as model_stats_file:
        ...
        model_serialized_path = os.path.join(model_output_dir_path, 'model-serialized-logistic.pkl')
        ...
        print("Accuracy of logistic accuracy is: " , accuracy)
        ...
        model_stats_file.write("Confusion Matrix:\n{}\n\n".format(cnf_matrix))
